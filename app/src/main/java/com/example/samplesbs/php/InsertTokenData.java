...
public class InsertTokenData extends AsyncTask<String, Void, String>{
    private Context mContext;

    public InsertTokenData(){};
    public InsertTokenData(Context context){mContext=context;}
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            outputStream.write(postParameter.getBytes("UTF-8"));//전송할 데이터가 저장된 변수를 이곳에 입력합니다. 인코딩을 고려해줘야 합니다.
            ...
            Log.e("ERROR", "InsertToken: Error ", e);
